...
//
// Bu baslik decode.exe ile pipeline.exe arasinda PAYLASILIYOR. Iki ayri
// yerde iki gramer tutmak ikisinin sessizce ayrismasi demek olurdu;
// tests/test_dilbilgisi.py zaten C++ ile Python'un ayrismasini sinamak
// icin yazilmisti, ayni riski C++'in kendi icinde yaratmayalim.
